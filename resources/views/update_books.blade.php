...
<body style="background-image:url(https://images2.alphacoders.com/261/26102.jpg)">
    ...
    <form action="/put/{{$id}}" method="POST" enctype="multipart/form-data">
        @method('PUT')
        @csrf
        <div class="mb-3">
    ...
    <footer>
        ...
        <p style="background-color:#416a59;bottom:0;height:50px;text-align:center;color:#fff;margin-top:220px;
        ">©Books</p>
    </footer>
</body>
</html>
